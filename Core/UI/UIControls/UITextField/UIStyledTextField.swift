...
@IBDesignable
public class UIStyledTextField: UITextField {
                ...
                attributedPlaceholder =
                    NSAttributedString(
                        ...
                        attributes: [
                            ...
                            .kern: Config.shared.appearance.defaultFontKerning
                        ])
            }
        }
    }
    ...
    public func setLeftPaddingImage(_ image: UIImage?, padding: CGFloat = sideImagePadding, tintColor: UIColor? = nil) {
        ...
        let imageHorizontalPadding: CGFloat = screenify(padding)
        ...
        imageView.contentMode = .scaleAspectFit
        imageView.image = leftPaddingImage
        imageView.tintColor = tintColor ?? Config.shared.appearance.defaultForegroundColor
        containerView.addSubview(imageView)
    ...
    public func setRightPaddingImage(_ image: UIImage?, padding: CGFloat = sideImagePadding, tintColor: UIColor? = nil) {
        ...
        let imageHorizontalPadding = screenify(padding)
    ...
    private typealias `Self` = UIStyledTextField
